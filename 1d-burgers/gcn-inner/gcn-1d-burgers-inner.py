...
def test_model(model_input,true_data):
    ...
    plot_2D(x_axis, u50,x_axis, y50,name='t050_gcn_in.pdf',label1='GCN', label2='True')
    plot_2D(x_axis, u75,x_axis, y75,name='t075_gcn_in.pdf',label1='GCN', label2='True')
    plot_2D(x_axis, u99,x_axis, y99,name='t099_gcn_in.pdf',label1='GCN', label2='True')
...
python gcn-1d-burgers-inner.py [--test]

Example for train:
python gcn-1d-burgers-inner.py
Example for test:
python gcn-1d-burgers-inner.py --test
"""
