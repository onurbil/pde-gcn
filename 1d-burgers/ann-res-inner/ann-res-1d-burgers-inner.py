...
"""
ANN-RES-Model for Burgers equation trained on CPU:
"""
...
# iputs:input data for the model. true_values: True values for output
...
MODEL_PATH = 'model-1d-burgers-ann-res.pt'
best_loss = 99999
...
def test_model(model_input,true_data):
    ...
    plot_2D(x_axis, u00,x_axis, y00,name='t000_ann-res.pdf', label1='ANN-RES', label2='True')
    plot_2D(x_axis, u95,x_axis, y95,name='t095_ann-res.pdf', label1='ANN-RES', label2='True')
    plot_2D(x_axis, u99,x_axis, y99,name='t099_ann-res.pdf', label1='ANN-RES', label2='True')
    
    u_plot = np.array(true_data-u_pred)
    u_plot = u_plot.reshape(nt,nx)
    plot_3D(u_plot, name='3d-plot_ann-res_1d-burgers.pdf')
...
python ann-res-1d-burgers-inner.py [--test]

Example for train:
python ann-res-1d-burgers-inner.py
Example for test:
python ann-res-1d-burgers-inner.py --test
"""
