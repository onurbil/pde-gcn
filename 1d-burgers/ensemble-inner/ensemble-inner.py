...
def test_model():
    ...
    plot_2D(x_axis, u50,x_axis, y50,name='t050_ens_in.pdf',label1='Ensemble', label2='True')
    plot_2D(x_axis, u75,x_axis, y75,name='t075_ens_in.pdf',label1='Ensemble', label2='True')
    plot_2D(x_axis, u99,x_axis, y99,name='t099_ens_in.pdf',label1='Ensemble', label2='True')
