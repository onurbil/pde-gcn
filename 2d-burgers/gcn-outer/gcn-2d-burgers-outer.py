...
xy_count = 26
t_count = 31
train_size = int(xy_count*xy_count*t_count*0.9) #(t_count-3)
...
MODEL_PATH = "model-2d-burgers-gcn.pt"
hidden = 12
...
def test_model(model_input,true_data):
    ...
    plot_3D(u_plot,name='3d-plot_gcn_2d-burgers.pdf')  



"""
To run from terminal enter:
python gcn-2d-burgers-outer.py [--test]

Example for train:
python gcn-2d-burgers-outer.py
Example for test:
python gcn-2d-burgers-outer.py --test
"""
