...
MODEL_PATH1 = "../ann-outer/model-2d-burgers-ann.pt"
...
MODEL_PATH2 = "../gcn-outer/model-2d-burgers-gcn.pt"
...
def test_model():
    ...
    test_loss = loss_func(u_pred[train_size:], true_values[train_size:])  
    max_loss = torch.max(torch.abs(u_pred[train_size:]-true_values[train_size:]))
