...
MODEL_PATH = "model-2d-schrödinger-ann-res.pt"
best_loss = 99999
...
def test_model(model_input,true_u, true_v):
    ...
    plot_3D(u_plot,name='3d-plot_ann-res_2d-schrödinger.pdf')    
    

"""
To run from terminal enter:
python ann-res-2d-schrödinger-outer.py [--test]

Example for train:
python ann-res-2d-schrödinger-outer.py
Example for test:
python ann-res-2d-schrödinger-outer.py --test
"""
