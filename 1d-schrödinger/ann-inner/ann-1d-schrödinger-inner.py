...
MODEL_PATH = 'model-1d-schrödinger-ann.pt'
best_loss = 99999
...
def test_model(model_input,true_data):
    ...
    for i in range(len(to_print)):
        ...
        plot_2D(x_axis,psi_pred,x_axis, psi,name='t{}_ann_1d-schrödinger_out.pdf'.format(t),label1='ANN', label2='True')
    ...
    plot_3D(u_plot, name='3d-plot_ann_1d-schrödinger.pdf')
...
python ann-1d-schrödinger-inner.py [--test]

Example for train:
python ann-1d-schrödinger-inner.py
Example for test:
python ann-1d-schrödinger-inner.py --test
"""
